...
config :journal, Journal.Repo,
  database: Path.expand("../journal_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :journal, JournalWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "hNd1iTIGNV2rd/TRjLwY7Qq1Ut+xH/FvgCNXKNuPcMxxvKvVUkemDAjidARULzjp",
  watchers: [
